...
export class AddPhoneToCustomerTable1690131370641 implements MigrationInterface {
    name = 'AddPhoneToCustomerTable1690131370641'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`purchases_products\` DROP FOREIGN KEY \`FK_7f2e96323fbbeff797e59082f86\``);
        await queryRunner.query(`ALTER TABLE \`customer\` ADD \`phone\` varchar(255) NOT NULL DEFAULT '12345678'`);
